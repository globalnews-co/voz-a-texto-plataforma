            ...
            await Conexion.subirArchivo(data).then((response) => {
                ...
                if (response.status == 200) {
                    Swal.fire({
                        ...
                        footer: '<a href="http://192.168.1.156:3000/noticia/' + response.data.filename.split(".")[0] + '" target="_blank">Ver Nota</a>'
                    });
                }
                else {
                    Swal.fire({
                ...
                <div className="modal-lg modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">Montar Nota</h5>
